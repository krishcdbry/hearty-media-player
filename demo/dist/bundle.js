...
var App = function (_React$Component) {
    ...
    function App(context, props) {
        ...
        return _possibleConstructorReturn(this, (App.__proto__ || Object.getPrototypeOf(App)).call(this, context, props));
    }

    _createClass(App, [{
        key: 'onVideoLoadCallback',
        value: function onVideoLoadCallback(video) {
            // video - video element returned from HeartyMediaPlayer
            console.log("Video Loaded", video);
        }
    }, {
        key: 'onStartVideoCallback',
        value: function onStartVideoCallback(video) {
            // video - video element returned from HeartyMediaPlayer
            console.log("Video Started", video);
        }
    }, {
        key: 'onEndVideoCallback',
        value: function onEndVideoCallback(video) {
            // video - video element returned from HeartyMediaPlayer
            console.log("Video Ended", video);
        }
    }, {
        key: 'onPauseVideoCallback',
        value: function onPauseVideoCallback(video) {
            // video - video element returned from HeartyMediaPlayer
            console.log("Video Paused", video);
        }
    }, {
        key: 'onForwardVideoCallback',
        value: function onForwardVideoCallback(video) {
            // video - video element returned from HeartyMediaPlayer
            console.log("Video forwaded", video);
        }
    }, {
        key: 'onBackwardVideoCallback',
        value: function onBackwardVideoCallback(video) {
            // video - video element returned from HeartyMediaPlayer
            console.log("Video backwarded", video);
        }
    }, {
        key: 'onSpeedChangeCallback',
        value: function onSpeedChangeCallback(video) {
            // video - video element returned from HeartyMediaPlayer
            console.log("Video playback Speed changed", video);
        }
    }, {
        key: 'onVolumeChangeCallback',
        value: function onVolumeChangeCallback(video) {
            // video - video element returned from HeartyMediaPlayer
            console.log("Video volume changed", video);
        }
    }, {
        key: 'onVideoFixedTopCallback',
        value: function onVideoFixedTopCallback(video) {
            // video - video element returned from HeartyMediaPlayer
            console.log("Video poped fixed to top of window", video);
        }
    }, {
        key: 'onVideoExitFixedTopCallback',
        value: function onVideoExitFixedTopCallback(video) {
            // video - video element returned from HeartyMediaPlayer
            console.log("Video exit from fixed top of window", video);
        }
    }, {
        key: 'onFullScreenCallback',
        value: function onFullScreenCallback(video) {
            // video - video element returned from HeartyMediaPlayer
            console.log("Video FullScreen", video);
        }
    }, {
        key: 'onExitFullScreenCallback',
        value: function onExitFullScreenCallback(video) {
            // video - video element returned from HeartyMediaPlayer
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'h2',
                            null,
                            ' Events (Loop, Poster, Preload, Autoplay etc) '
                        ),
                        _react2.default.createElement(
                            'i',
                            null,
                        ...
                        _react2.default.createElement('br', null),
                        _react2.default.createElement(_index2.default, (_React$createElement = {
                        ...
                        }, _defineProperty(_React$createElement, 'allowFullScreen', true), _defineProperty(_React$createElement, 'allowForward', true), _defineProperty(_React$createElement, 'allowBackward', true), _defineProperty(_React$createElement, 'allowFixedTop', true), _defineProperty(_React$createElement, 'allowSpeedControls', true), _defineProperty(_React$createElement, 'onLoadVideo', this.onVideoLoadCallback.bind(this)), _defineProperty(_React$createElement, 'onStartVideo', this.onStartVideoCallback.bind(this)), _defineProperty(_React$createElement, 'onPauseVideo', this.onPauseVideoCallback.bind(this)), _defineProperty(_React$createElement, 'onEndVideo', this.onEndVideoCallback.bind(this)), _defineProperty(_React$createElement, 'onForwardVideo', this.onForwardVideoCallback.bind(this)), _defineProperty(_React$createElement, 'onBackwardVideo', this.onBackwardVideoCallback.bind(this)), _defineProperty(_React$createElement, 'onSpeedChange', this.onSpeedChangeCallback.bind(this)), _defineProperty(_React$createElement, 'onVolumeChange', this.onVolumeChangeCallback.bind(this)), _defineProperty(_React$createElement, 'onVideoFixedTop', this.onVideoFixedTopCallback.bind(this)), _defineProperty(_React$createElement, 'onVideoExitFixedTop', this.onVideoExitFixedTopCallback.bind(this)), _defineProperty(_React$createElement, 'onFullScreen', this.onFullScreenCallback.bind(this)), _defineProperty(_React$createElement, 'onExitFullScreen', this.onExitFullScreenCallback.bind(this)), _React$createElement))
                    )
                )
            );
        }
    ...
    _createClass(HeartyMediaPlayer, [{
        ...
        value: function _fixVideoTop() {
            var _props = this.props,
                onVideoFixedTop = _props.onVideoFixedTop,
                onVideoExitFixedTop = _props.onVideoExitFixedTop;
        ...
        */
        ...
        value: function preareVideoSource() {
            ...
            if (this.state.src) {
                ...
                if (_constants.validVideoTypes.indexOf(type) > -1) {
                    videoType += type;
                    sourceElem = _react2.default.createElement('source', { src: this.state.src, type: videoType });
                }
            }
            return sourceElem;
        }
        ...
        value: function render() {
            ...
            var playPauseElem = _react2.default.createElement('img', { src: '../assets/play.png' });
            var playPauseFun = this._play.bind(this);
            var videoCurtainClass = 'video-curtain show';

            if (this.state.playing) {
                playPauseElem = _react2.default.createElement('img', { src: '../assets/pause.png' });
                playPauseFun = this._pause.bind(this);
                videoCurtainClass = 'video-curtain';
            }

            if (this.state.replay) {
                playPauseElem = _react2.default.createElement('img', { src: '../assets/replay.png' });
            ...
            var videoControlsClassName = this.state.fullScreen ? 'video-controls fullscreen-mode' : 'video-controls';
            ...
            var heartyMediaPlayerId = this.state.id || (0, _helpers.generateRandomId)();

            var fixedTopIcon = this.state.fixedTop ? '../assets/fixed-remove.png' : '../assets/fixed-top.png';
            ...
            var fullScreenOption = this.props.allowFullScreen ? _react2.default.createElement(
                ...
                _react2.default.createElement('img', { src: '../assets/fullscreen.png' })
            ) : '';
            ...
            var forwardOption = this.props.allowForward ? _react2.default.createElement(
                ...
                _react2.default.createElement('img', { src: '../assets/forward.png' })
            ) : '';
            ...
            var backwardOption = this.props.allowBackward ? _react2.default.createElement(
                ...
                _react2.default.createElement('img', { src: '../assets/backward.png' })
            ) : '';
            ...
            return _react2.default.createElement(
                ...
                { className: heartyMediaPlayerClass,
                    ...
                    onMouseOut: function onMouseOut() {
                        return _this3._mouseOut();
                    },
                    onMouseOver: function onMouseOver() {
                        return _this3._mouseOver();
                    } },
                _react2.default.createElement(
                    'div',
                            ...
                            _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    ...
                                                    { onClick: function onClick() {
                                                            return _this3._setupPlaybackRate(0.25);
                                                        } },
                                                    '0.25x'
                                                ),
                                                ' '
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    'span',
                                                    { onClick: function onClick() {
                                                            return _this3._setupPlaybackRate(0.5);
                                                        } },
                                                    '0.5x'
                                                ),
                                                ' '
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    'span',
                                                    { onClick: function onClick() {
                                                            return _this3._setupPlaybackRate(1);
                                                        } },
                                                    '1x'
                                                ),
                                                ' '
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement(
                                                    'span',
                                                    { onClick: function onClick() {
                                                            return _this3._setupPlaybackRate(2);
                                                        } },
                                                    '2x'
                                                ),
                                                ' '
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement('div', { onClick: function onClick() {
                                            return _this3._setupVolume(1);
                                        }, className: volumeClassOne }),
                                    _react2.default.createElement('div', { onClick: function onClick() {
                                            return _this3._setupVolume(2);
                                        }, className: volumeClassTwo }),
                                    _react2.default.createElement(
                                        'div',
                                        { onClick: function onClick() {
                                                return _this3._setupVolume(3);
                                            }, className: volumeClassThree },
                                        ' '
                                    ),
                                    _react2.default.createElement('div', { onClick: function onClick() {
                                            return _this3._setupVolume(4);
                                        }, className: volumeClassFour }),
                                    _react2.default.createElement('div', { onClick: function onClick() {
                                            return _this3._setupVolume(5);
